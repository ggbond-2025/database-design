...
- 开课安排保存周一到周五的上课时间段；管理员新增或编辑开课安排时选择当日第几节课，系统自动映射为 `08:00-09:40`、`09:55-11:35`、`13:30-15:10`、`15:25-17:05`、`18:30-20:10` 五个固定时间段；表单会根据课程学时显示一组或两组课程时间。
...
- 学生可提交转专业申请，管理员审核通过时选择目标专业下的转入班级；审核只更新学生当前班级，历史选课、成绩和已完成课程记录保留。
